...
async function testPriorityAPI() {
  try {
    ...
    const poResponse = await fetch('http://localhost:3001/api/v1/admin/pos/359/priority', {
      method: 'PUT',
      headers: {
    ...
    const lineItemResponse = await fetch('http://localhost:3001/api/v1/admin/pos/359/line-items/6051/priority', {
      method: 'PUT',
      headers: {
        'Content-Type': 'application/json',
        'Authorization': 'Bearer YOUR_TOKEN_HERE' // You'll need to get a valid token
    ...
    console.log('1. POST https://ditos.technoboost.in/api/v1/purchase-order/purchase-order/priority');
    console.log('   Payload: { "poNumber": "PO_NUMBER", "combinationNumber": null, "priorityName": "HIGH" }');
    console.log('\n2. POST https://ditos.technoboost.in/api/v1/purchase-order/purchase-order/priority');
    console.log('   Payload: { "poNumber": "PO_NUMBER", "combinationNumber": 123, "priorityName": "URGENT" }');
